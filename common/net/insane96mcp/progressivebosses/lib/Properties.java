...
public class Properties {
	...
	public static class Wither{
		...
		public static void Init() {
			...
			bonusHealthPerSpawned = Config.LoadFloatProperty(CATEGORY, "bonus_health_per_spawned", "How much health the withers will have more for each wither that has been already spawned", 25f);
	...
	public static class Dragon{
		...
		public static void Init() {
			bonusHealthPerKilled = Config.LoadFloatProperty(CATEGORY, "bonus_health_per_killed", "How much health will have the ender dragon for each ender dragon that has been killed", 25f);
			...
			bonusArmorPerKilled = Config.LoadFloatProperty(CATEGORY, "bonus_armor_per_killed", "How much armor points will have ender dragons for each time a dragon is killed", 0.5f);
			maximumArmor = Config.LoadFloatProperty(CATEGORY, "maximum_armor", "Maximum armor points that enderdragons can spawn with. It's not recommended to go over 30", 10f);
		}
	}
}
