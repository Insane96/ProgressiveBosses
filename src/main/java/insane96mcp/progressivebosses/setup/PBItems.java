...
public class PBItems {
    ...
    public static final RegistryObject<Item> CORRUPTED_END_CRYSTAL = PBItems.REGISTRY.register("corrupted_end_crystal", () -> new CorruptedEndCrystalItem(new Item.Properties()));
}
