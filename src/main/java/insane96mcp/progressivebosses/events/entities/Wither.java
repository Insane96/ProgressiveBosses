...
public class Wither {
    ...
    private static void setExperience(WitherEntity wither, float difficulty) {
        ...
        Reflection.set(Reflection.MobEntity_experienceValue, wither, xp);
    }
    ...
    public static void update(LivingEvent.LivingUpdateEvent event) {
        ...
        if (wither.getInvulTime() > 0) {
            Reflection.invoke(Reflection.BossInfoServer_setPercent, Reflection.get(Reflection.WitherEntity_bossInfo, wither), wither.getHealth() / wither.getMaxHealth());
        } else {
        ...
        if (cooldown > 0) {
            ...
            for (int i = ModConfig.Wither.Minions.difficultyToSpawn.get(); i <= difficulty; i++) {
                ...
                if (spawn % ModConfig.Wither.Minions.difficultyToSpawnOneMore.get() == 0) {
                    ...
                    Reflection.set(Reflection.MobEntity_deathLootTable, witherSkeleton, new ResourceLocation("minecraft:empty"));
                    Reflection.set(Reflection.MobEntity_experienceValue, witherSkeleton, 1);
