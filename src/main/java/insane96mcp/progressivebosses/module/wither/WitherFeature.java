...
public class WitherFeature extends Feature {
	public static final List<WitherStats> DEFAULT_WITHER_STATS = new ArrayList<>(List.of(
			...
			new WitherStats(1,
					new WitherAttack(10f, 1.7f, 0.15f, 45, 55, 2f, 1, 0.06f, 12f, 60, 0.05f, 50, 75, 5),
					new WitherHealth(400f, 1.25f, 1f, 30),
					new WitherResistancesWeaknesses(new PoweredValue(9f, 16f), new PoweredValue(6f, 8f), 300f),
			...
			new WitherStats(2,
					new WitherAttack(13f, 2.1f, 0.15f, 40, 45, 2f, 1, 0.06f, 17f, 50, 0.05f, 50, 90, 4),
					new WitherHealth(500f, 1.5f, 0.8f, 30),
					new WitherResistancesWeaknesses(new PoweredValue(12f, 18f), new PoweredValue(9f, 12f), 375f),
			...
			new WitherStats(3,
					new WitherAttack(16f, 2.5f, 0.15f, 35, 45, 2f, 1, 0.06f, 24f, 40, 0.05f, 50, 100, 3),
					new WitherHealth(600f, 2f, 0.6f, 35),
					new WitherResistancesWeaknesses(new PoweredValue(15f, 20f), new PoweredValue(12f, 16f), 450f),
