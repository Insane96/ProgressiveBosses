...
public class WitherFeature extends Feature {
	public static final List<WitherStats> DEFAULT_WITHER_STATS = new ArrayList<>(List.of(
			new WitherStats(0,
					...
					new WitherResistancesWeaknesses(new PoweredValue(6f, 13f), new PoweredValue(3f, 4f)),
			...
			new WitherStats(1,
					...
					new WitherResistancesWeaknesses(new PoweredValue(10f, 16f), new PoweredValue(6f, 8f)),
			...
			new WitherStats(2,
					...
					new WitherResistancesWeaknesses(new PoweredValue(13f, 19f), new PoweredValue(9f, 12f)),
			...
			new WitherStats(3,
					...
					new WitherResistancesWeaknesses(new PoweredValue(17f, 22f), new PoweredValue(12f, 16f)),
