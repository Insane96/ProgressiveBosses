...
public class WitherFeature extends Feature {
	public static final List<WitherStats> DEFAULT_WITHER_STATS = new ArrayList<>(List.of(
			...
			new WitherStats(1,
					new WitherAttack(10f, 1.7f, 0.15f, 45, 55, 1.8f, 1, 0.06f, 12f, 60, 0.05f, 50, 75, 5),
			...
			new WitherStats(2,
					new WitherAttack(13f, 2.1f, 0.15f, 40, 45, 1.65f, 1, 0.06f, 17f, 50, 0.05f, 50, 90, 4),
			...
			new WitherStats(3,
					new WitherAttack(16f, 2.5f, 0.15f, 35, 45, 1.5f, 1, 0.06f, 24f, 40, 0.05f, 50, 100, 3),
