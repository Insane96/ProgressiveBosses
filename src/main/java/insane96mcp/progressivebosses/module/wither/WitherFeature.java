...
public class WitherFeature extends Feature {
	public static final List<WitherStats> DEFAULT_WITHER_STATS = new ArrayList<>(List.of(
			new WitherStats(0,
					...
					new WitherMinionStats(new PoweredValue(1), new PoweredValue(2), new PoweredValue(300, 150), new PoweredValue(450, 225), new PoweredValue(0.1f), 4f, new PoweredValue(0.7f, 0.3f), 0.3f, 0.3f, 0.4f, 0.2f),
			...
			new WitherStats(1,
					...
					new WitherMinionStats(new PoweredValue(2), new PoweredValue(4), new PoweredValue(350, 175), new PoweredValue(525, 260), new PoweredValue(0.15f), 4f, new PoweredValue(0.7f, 0.3f), 0.6f, 0.6f, 0.8f, 0.4f),
			...
			new WitherStats(2,
					...
					new WitherMinionStats(new PoweredValue(3), new PoweredValue(6), new PoweredValue(400, 200), new PoweredValue(600, 300), new PoweredValue(0.20f), 4f, new PoweredValue(0.7f, 0.3f), 0.9f, 0.9f, 1.2f, 0.6f),
			...
			new WitherStats(3,
					...
					new WitherMinionStats(new PoweredValue(4), new PoweredValue(8), new PoweredValue(450, 225), new PoweredValue(675, 335), new PoweredValue(0.25f), 4f, new PoweredValue(0.7f, 0.3f), 1.2f, 1.2f, 1.6f, 0.8f),
