...
public class WitherFeature extends Feature {
	public static final List<WitherStats> DEFAULT_WITHER_STATS = new ArrayList<>(List.of(
			new WitherStats(0,
					new WitherAttack(8f, 2f, 0.05f, 45, 70, 0.05f, 8f, 70, 0.05f, 20, 40, 5),
					new WitherHealth(300f, 1f, 1f, 30),
					new WitherResistancesWeaknesses(new PoweredValue(6f, 13f), new PoweredValue(3f, 4f), 225f),
					new WitherMinionStats(new PoweredValue(1), new PoweredValue(2), new PoweredValue(400, 200), new PoweredValue(500, 250), new PoweredValue(0.1f), 4f, new PoweredValue(0.7f, 0.3f), 0.3f, 0.3f, 0.4f, 0.2f),
					new WitherMiscStats(7f, false, false, false),
					250, new ResourceLocation("progressivebosses:entities/wither_0")),
			new WitherStats(1,
					new WitherAttack(10f, 2.2f, 0.05f, 40, 60, 0.05f, 12f, 60, 0.05f, 30, 60, 5),
					new WitherHealth(400f, 1.25f, 1f, 30),
					new WitherResistancesWeaknesses(new PoweredValue(9f, 16f), new PoweredValue(6f, 8f), 250f),
					new WitherMinionStats(new PoweredValue(2), new PoweredValue(4), new PoweredValue(400, 200), new PoweredValue(500, 250), new PoweredValue(0.15f), 4f, new PoweredValue(0.7f, 0.3f), 0.6f, 0.6f, 0.8f, 0.4f),
					new WitherMiscStats(8f, false, true, false),
					600, new ResourceLocation("progressivebosses:entities/wither_1")),
			new WitherStats(2,
					new WitherAttack(13f, 2.4f, 0.05f, 35, 50, 0.05f, 17f, 50, 0.05f, 40, 80, 4),
					new WitherHealth(500f, 1.5f, 0.8f, 30),
					new WitherResistancesWeaknesses(new PoweredValue(12f, 18f), new PoweredValue(9f, 12f), 275f),
					new WitherMinionStats(new PoweredValue(3), new PoweredValue(6), new PoweredValue(400, 200), new PoweredValue(500, 250), new PoweredValue(0.20f), 4f, new PoweredValue(0.7f, 0.3f), 0.9f, 0.9f, 1.2f, 0.6f),
					new WitherMiscStats(9f, false, true, false),
					950, new ResourceLocation("progressivebosses:entities/wither_2")),
			new WitherStats(3,
					new WitherAttack(16f, 2.6f, 0.05f, 30, 40, 0.05f, 24f, 40, 0.05f, 50, 100, 3),
