...
public class WitherFeature extends Feature {
	public static final List<WitherStats> DEFAULT_WITHER_STATS = new ArrayList<>(List.of(
			new WitherStats(0,
					new WitherAttack(8f, 1.5f, 0.1f, 45, 70, 0, 0.05f, 8f, 70, 0.05f, 20, 40, 5),
			...
			new WitherStats(1,
					new WitherAttack(10f, 1.7f, 0.09f, 40, 60, 1, 0.05f, 12f, 60, 0.05f, 30, 60, 5),
			...
			new WitherStats(2,
					new WitherAttack(13f, 2.1f, 0.075f, 35, 50, 1, 0.05f, 17f, 50, 0.05f, 40, 80, 4),
