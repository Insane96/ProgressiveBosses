...
public class DifficultyFeature extends Feature {
	...
	public static final List<WitherStats> DEFAULT_WITHER_STATS = new ArrayList<>(List.of(
			...
			new WitherStats(1,
					new WitherAttackStats(12f, 2.2f, 40, 65, 0.05f, 16f, 45, 0.075f, 60),
			...
			new WitherStats(2,
					new WitherAttackStats(16f, 2.4f, 35, 60, 0.05f, 20f, 40, 0.010f, 80),
			...
			new WitherStats(3,
					new WitherAttackStats(20f, 2.6f, 30, 55, 0.05f, 24f, 35, 0.015f, 100),
